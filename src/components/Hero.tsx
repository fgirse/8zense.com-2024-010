    ...
    <section id="section-Hero" className="">
      <div className=" flex min-h-screen flex-col items-center">
        ...
        <div className="bg-gradient to-bottom from mx-auto flex w-full flex-col items-center justify-between bg-black/80 to-transparent">
          <section className="">
            <h1 className="text sm-leading-3 lg:text-zenseWhite relative mt-20 h-60 rounded-xl bg-gradient-to-b from-slate-800 to-transparent p-2 text-4xl font-black  uppercase text-neutral-100 sm:py-12 sm:text-4xl md:text-6xl lg:relative lg:py-6 lg:text-left lg:text-[4.33rem] lg:font-black lg:uppercase  lg:leading-9 xl:text-[4.66rem] 2xl:text-[7.166rem]">
              Design interior
            </h1>
